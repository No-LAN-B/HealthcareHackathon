...
import { Send, Loader2, FileText, AlertTriangle, Brain } from "lucide-react";
...
export default function ReferralPacket({
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 p-6">
      ...
      {/* Waiting state — before AI extraction */}
      {!extraction && (
        <div className="flex flex-col items-center py-8 text-center">
          ...
          <p className="text-sm text-gray-500 max-w-xs">
            AI is listening to the appointment. A referral packet will appear
            when clinical indicators are detected.
          </p>
        </div>
      )}

      {/* Active form — after AI extraction */}
      {extraction && (
        <div className="animate-fade-in">
          ...
          {/* Key Symptoms */}
          {extraction.key_symptoms.length > 0 && (
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 mb-1.5">
                Key Symptoms
              </label>
          ...
          <textarea
            ...
            placeholder="AI-generated clinical note will appear here..."
